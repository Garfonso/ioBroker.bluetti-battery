...
const OutputMode: EnumMap = { 0: 'STOP', 1: 'INVERTER_OUTPUT', 2: 'BYPASS_OUTPUT_C', 3: 'BYPASS_OUTPUT_D', 4: 'LOAD_MATCHING' };
...
const buildAC200M: Builder = () => {
	...
	return {
		...
		packNumMax: 3,
		struct: s,
		pollingCommands: [new ReadHoldingRegisters(10, 40), new ReadHoldingRegisters(70, 21), new ReadHoldingRegisters(3001, 61)],
